...
const ICONS = {
  ...
  reddit: (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        fill="currentColor"
        d="M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 0 1-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.632 4.674 1.488.308-.309.73-.491 1.207-.491.968 0 1.754.786 1.754 1.754 0 .716-.435 1.333-1.01 1.614a3.111 3.111 0 0 1 .042.52c0 2.694-3.03 4.87-7.004 4.87-3.974 0-7.004-2.176-7.004-4.87 0-.183.015-.366.043-.534A1.748 1.748 0 0 1 4.028 12c0-.968.786-1.754 1.754-1.754.463 0 .898.196 1.207.49 1.207-.883 2.878-1.43 4.744-1.487l-.882-4.153a.342.342 0 0 1-.114-.2.187.187 0 0 1 .082-.155c.107-.075.243-.123.403-.122zm-8.085 8.376h-.001a1.25 1.25 0 1 0 .001 2.498 1.25 1.25 0 0 0-.001-2.498zm7.924 0a1.25 1.25 0 1 0 .001 2.498 1.25 1.25 0 0 0-.001-2.498z"
      />
    </svg>
  ),
  email: (
        ...
        <ul className="article-share__list">
          {SHARE_PLATFORMS.map((platform) => (
            <li key={platform.id}>
              ...
              >
                <span className="article-share__icon">{ICONS[platform.id]}</span>
          ...
          <li>
            ...
            >
              <span className="article-share__icon">{ICONS.link}</span>
